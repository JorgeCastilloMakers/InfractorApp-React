...
import ModalAprove from '../ModalAprove/ModalAprove';
...
export const Dashboard = () => {
  ...
  //Funcion que sirve que cambia la clave "aprove" a "true", esto modifica la db en Firestore y vuelve a recargar el grid.
    ...
    <motion.div
      ...
      <div className='dashboard_container_boxes'>
        ...
        <Box className='dashboard_box_infringement'>
          ...
          {dataPreview && <ModalAprove
            dataPreview={dataPreview}
            modalAprove={modalAprove}
            setModalAprove={setModalAprove}
            aproveInfringement={aproveInfringement}
            rejectInfringement={rejectInfringement}
